// USING BACKTRACTING IN DFS  GIVES TLE 

//T.C : O(V^2)
class Solution {
public:
    // erase() does not leave empty cells
    // It removes the element
    // All later elements shift left
    // Therefore no empty string ever appears in the DFS route
...
// USING Hierholzer's algorithm (USED FOR FINDING EULER'S PATH) [isme hame starting node chahiye fir vha se dfs maro or edge remove karte jao]
// TC : O(nlogn)
